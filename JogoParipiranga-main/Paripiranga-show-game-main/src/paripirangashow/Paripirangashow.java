...
public class Paripirangashow {
    ...
    pergs[3]=new Pergunta(4, 1, 'c', "Qual desses nomes já foi de Paripiranga?", "Terra do Coite", "Serra Vermelha", "Pat. do Coite", "Serra do Coite");
    ...
    pergs[5]=new Pergunta(6, 1, 'c', "Qual dessas pessoas não foi prefeito de Paripiranga?", "Vicente V. da Cunha", "Joaquim de M. Carregosa", "Gustavo de M Costa", "Jonathas L.de Menezes");
